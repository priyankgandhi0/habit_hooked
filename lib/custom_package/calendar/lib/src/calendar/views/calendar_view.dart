...
class _ViewHeaderViewPainter extends CustomPainter {
  ...
  String _updateViewHeaderFormat(String dayFormat, String dayText) {
    switch (view) {
      ...
      case CalendarView.workWeek:
        {
          if (!CalendarViewHelper.isDayView(
                  ...
                  timeSlotViewSettings.nonWorkingDays,
                  monthViewSettings.numberOfWeeksInView) &&
              (dayFormat == 'EEE' && (locale.contains('en')))) {
            return dayText[0];
          }
          break;
        }
      ...
      case CalendarView.month:
        {
          //// EEE format value shows the week days as S, M, T, W, T, F, S.
          if (dayFormat == 'EEE' && (locale.contains('en'))) {
            return dayText[0];
          }
        }
    }
...
class ShapePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(startingPoint & const Size(100,55),paint);
